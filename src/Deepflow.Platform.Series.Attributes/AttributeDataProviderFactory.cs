...
namespace Deepflow.Platform.Series.Attributes
{
    public class AttributeDataProviderFactory : IAttributeDataProviderFactory
    {
        ...
        {
            return new AttributeDataProvider(entity, attribute, _store, _validator, _aggregator, _seriesKnower, _filterer, _aggregatedMerger, _timeMerger, _configuration, _logger, _tripCounterFactory);
        }
    }
}
