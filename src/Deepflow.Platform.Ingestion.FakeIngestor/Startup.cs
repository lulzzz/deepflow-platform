...
using Deepflow.Platform.Ingestion.FakeIngestor.Realtime;
...
namespace Deepflow.Platform.Ingestion.FakeIngestor
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IWebsocketsReceiver, RealtimeReceiver>();
        }
